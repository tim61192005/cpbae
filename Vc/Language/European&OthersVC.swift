...
class European_OthersVC: BaseViewController {
    //隱藏StatusBar
    ...
    let accessToken =  KeychainWrapper.standard.data(forKey: "accessToken")
             self.pageWebView = UIWebView(frame: self.view.bounds)
                     ...
                     let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/search?type=0200&sub=0204&token=?")
