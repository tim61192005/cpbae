...
class LanguageOverviewVC: BaseViewController {
...
////            print("幹幹幹幹幹幹幹幹幹幹",plainData as Any)
//            let base64String = plainData?.base64EncodedString()
////            print("幹幹幹幹幹幹幹幹幹幹" + base64String!)
//
...
//                     let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/search?type=0200&sub=0200")
                   
                   let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/search?type=0200&sub=0200&token=?")
