...
class LibraryManagementVC: BaseViewController {
    //隱藏StatusBar
        ...
        override func viewDidLoad() {
            super.viewDidLoad()
             ...
             self.pageWebView = UIWebView(frame: self.view.bounds)
                     ...
                     let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/search?type=0100&sub=0103&token=?")
