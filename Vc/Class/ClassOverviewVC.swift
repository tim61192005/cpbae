...
class ClassOverviewVC: BaseViewController {
    //隱藏StatusBar
...
//                 let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/redirect?token=\(String(describing: tokenString))&path=search?type=0100&sub=0100")
                    
        
        let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/search?type=0100&sub=0100&token=?")
