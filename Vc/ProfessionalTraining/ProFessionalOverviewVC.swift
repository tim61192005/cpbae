...
class ProFessionalOverviewVC: BaseViewController {
    //隱藏StatusBar
        ...
        override func viewDidLoad() {
            super.viewDidLoad()
             ...
             self.pageWebView = UIWebView(frame: self.view.bounds)
                     ...
                     let webUrl = URL(string: "https://sc2.sce.pccu.edu.tw/cpbae/search?type=0300&sub=0300&token=?")
